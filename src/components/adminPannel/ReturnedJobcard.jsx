...
const ReturnedJobCard = () => {
    ...
    const searchJobCards = async () => {
        try {
            ...
            const response = await axios.get(`${apiBaseUrl}/search?page=${currentPage}&limit=6&returned=${true}&searchTerm=${searchTerm}&${warranty ? "warranty=true" : ""}`);
    ...
    return (
        <div className="min-h-screen w-full px-4 py-6 ">
            <div className="flex flex-col items-start w-full max-w-7xl mx-auto">
                <h1 className="text-4xl font-bold text-white mb-4">Retuned Works</h1>
...
export default ReturnedJobCard;
